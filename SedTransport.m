...
figure
plot(PhaseM4,DIFF_phase)
title('Sensitivity analysis of difference in peak sediment concentration between peak flow and peak ebb for varying phase differences between M2 and M4');
